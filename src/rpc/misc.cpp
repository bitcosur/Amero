...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total amero balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized amero balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "amero|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "amero")
            + HelpExampleRpc("debug", "amero,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"ameroaddress\"\n"
            "\nReturn information about the given amero address.\n"
            "\nArguments:\n"
            "1. \"ameroaddress\"     (string, required) The amero address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"ameroaddress\", (string) The amero address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"")
            + HelpExampleRpc("validateaddress", "\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: Amero address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are amero addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) amero address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"ameroaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"ameroaddress\"  (string, required) The amero address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"AbnaQaoAe2XcLtK4iJZe9gHs1PUgJX2HaF\"]}")
        );
