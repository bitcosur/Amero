...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AmeroNetwork") type = AmeroNetwork;
    if(strType == "AmeroNetworkVariable") type = AmeroNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AmeroNetwork) s = "AmeroNetwork";
    if(type == AmeroNetworkVariable) s = "AmeroNetworkVariable";
