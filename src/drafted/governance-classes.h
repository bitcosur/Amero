 ...
 *
 *   // network
 *   CAmeroNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.amero.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAmeroNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AmeroNetwork
// //   -- signature requirements : Key1(User)
// class CAmeroNetworkVariable : public CGovernanceObject
// {
// private:
