    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Amero Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Amero address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and amero: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Amero Core"), this);
    aboutAction->setStatusTip(tr("Show information about Amero Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Amero Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Amero addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Amero addresses"));
    ...
    openAction->setStatusTip(tr("Open a amero: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Amero Core help message to get a list with possible Amero Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Amero Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Amero network", "", count));
    } else {
...
{
    QString strTitle = tr("Amero Core"); // default title
