    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Amero Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Amero Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  amero-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Amero in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 AMX, 0.1 AMX, 1 AMX and 10 AMX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://ameropay.atlassian.net/wiki/display/DOC/PrivateSend\">https://ameropay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Amero Core is shutting down...") + "<br /><br />" +
