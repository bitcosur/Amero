    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("AMERO-light"), QVariant("light"));
    ui->theme->addItem(QString("AMERO-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("AMERO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("AMERO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("AMERO-traditional"), QVariant("trad"));
