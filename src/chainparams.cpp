...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000004dc9bd956bf79a7b1687ae0829a9af924b192d564fc77cea2fd9572b3f3"); // TODO: update
        ...
        genesis = CreateGenesisBlock(1519390800, 385595, 0x1e0ffff0, 1, 1 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x000004dc9bd956bf79a7b1687ae0829a9af924b192d564fc77cea2fd9572b3f3")),
            1519390800, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000113427a40ffd316e8d2c6104d662d86e7263352c2edb3c974f1d283d2b7");
        ...
        genesis = CreateGenesisBlock(1519356090UL, 2466105UL, 0x1e0ffff0, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000113427a40ffd316e8d2c6104d662d86e7263352c2edb3c974f1d283d2b7"));
        assert(genesis.hashMerkleRoot == uint256S("0x5b5b31ffb9ce07446713694a385f5f15ec0ecd384408f5c17dfd32eb88231a6a"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x00000113427a40ffd316e8d2c6104d662d86e7263352c2edb3c974f1d283d2b7")),
            1519356090,  // * UNIX timestamp of last checkpoint block
            0,          // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
