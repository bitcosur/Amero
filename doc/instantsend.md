...
This mechanism has been integrated into Bitcore-Node-Amero which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ameropay/insight-api-amero#web-socket-api](https://github.com/ameropay/insight-api-amero#web-socket-api)
* API: [https://github.com/ameropay/insight-api-amero#instantsend-transactions](https://github.com/ameropay/insight-api-amero#instantsend-transactions)
...
By default, the Amero Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Amero Core daemon:
