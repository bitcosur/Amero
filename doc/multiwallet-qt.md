...
Only requiring some minor changes is amero.cpp.
...
Changes to amero.cpp
----------------------
amero.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
